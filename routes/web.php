...
Route::get('catalog-request','HomeController@catalogRequest');

Route::post('catalog-request-submit','HomeController@catalogRequestSubmit');
...
Route::get('special-offer','HomeController@specialOffer');
Route::get('career','HomeController@careers');
Route::get('contact-us','HomeController@contactUs');
Route::get('store','HomeController@shop');
Route::get('store-details/{id}','HomeController@storeDetail');
Route::get('terms-conditions','HomeController@termsConditions');
Route::post('search','HomeController@filterItems');
Route::post('main-search','HomeController@MainSearch');
Route::get('import-csv','HomeController@importCsv');

// Moiz Routes 24-08-2021
...
//===================== Shop Controller Routes Below ========================//
Route::post('create-cart','ShopController@createCart');
Route::get('show-cart','ShopController@cart');
Route::get('remove-item/{id}','ShopController@removeItems');
...
Route::post('admin/job/store','Admin\JobsController@store');
Route::get('admin/job/edit/{id}','Admin\JobsController@edit');
Route::post('/admin/job/update/{id}','Admin\JobsController@update');
Route::post('/admin/job/{id}','Admin\JobsController@delete');
